...
figure(1);hold on;
a1=0.5*s+sqrt(1/4-(s-0.5).^2)/beta;
b1=0.5*t-sqrt(1/4-(t-0.5).^2)/beta;
h1=plot(cat(2,s,t,0),cat(2,a1,b1,0));
h1.LineWidth=3;
h1.Color=addcolor(195);

beta=2;
a2=0.5*s+sqrt(1/4-(s-0.5).^2)/beta;
b2=0.5*t-sqrt(1/4-(t-0.5).^2)/beta;
h2=plot(cat(2,s,t,0),cat(2,a2,b2,0));
h2.LineWidth=3;
h2.Color=addcolor(165);

beta=1;
a3=0.5*s+sqrt(1/4-(s-0.5).^2)/beta;
b3=0.5*t-sqrt(1/4-(t-0.5).^2)/beta;
...
yticklabels({'-0.2','0','0.2','0.4','0.6','0.8'});
